#
#  Be sure to run `pod spec lint SheetController.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/apstygo/SheetController"
  ...
  # Or just: spec.author    = "Artyom Pstygo"
  # spec.authors            = { "Artyom Pstygo" => "apstygo@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Artyom Pstygo"
  ...
  spec.source       = { :git => "https://github.com/apstygo/SheetController", :tag => "#{spec.version}" }
